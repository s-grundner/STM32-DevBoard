...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI3_NSS2_GPIO_Port, SPI3_NSS2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : SPI3_NSS1_Pin */
  GPIO_InitStruct.Pin = SPI3_NSS1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPI3_NSS1_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SPI3_NSS2_Pin */
  GPIO_InitStruct.Pin = SPI3_NSS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPI3_NSS2_GPIO_Port, &GPIO_InitStruct);
